...
ADDON_SCRIPT="https://raw.githubusercontent.com/doge0420/ProxmoxVE/main/tools/addon/komodo.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/doge0420/ProxmoxVE/main/tools/addon/komodo.sh)"
MIGRATION_EOF
