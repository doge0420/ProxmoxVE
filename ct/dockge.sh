...
ADDON_SCRIPT="https://raw.githubusercontent.com/doge0420/ProxmoxVE/main/tools/addon/dockge.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/doge0420/ProxmoxVE/main/tools/addon/dockge.sh)"
MIGRATION_EOF
