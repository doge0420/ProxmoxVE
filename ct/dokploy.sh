...
ADDON_SCRIPT="https://raw.githubusercontent.com/doge0420/ProxmoxVE/main/tools/addon/dokploy.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/doge0420/ProxmoxVE/main/tools/addon/dokploy.sh)"
MIGRATION_EOF
