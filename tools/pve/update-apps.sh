...
source <(curl -fsSL https://raw.githubusercontent.com/doge0420/ProxmoxVE/refs/heads/main/misc/core.func)
...
for container in $CHOICE; do
  ...
  script=$(curl -fsSL https://raw.githubusercontent.com/doge0420/ProxmoxVE/main/ct/${service}.sh)
