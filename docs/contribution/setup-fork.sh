...
# upstream   https://github.com/doge0420/ProxmoxVE.git (fetch)
# upstream   https://github.com/doge0420/ProxmoxVE.git (push)
```
...
print_info "Upstream: https://github.com/doge0420/ProxmoxVE"
echo ""
