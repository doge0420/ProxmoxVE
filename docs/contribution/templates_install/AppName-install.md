...
```bash
#!/usr/bin/env bash
source <(curl -fsSL https://raw.githubusercontent.com/doge0420/ProxmoxVE/main/misc/install.func)
...
- [Trip](https://github.com/doge0420/ProxmoxVE/blob/main/install/trip-install.sh)
- [Thingsboard](https://github.com/doge0420/ProxmoxVE/blob/main/install/thingsboard-install.sh)
- [UniFi](https://github.com/doge0420/ProxmoxVE/blob/main/install/unifi-install.sh)
